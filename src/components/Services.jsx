          ...
          {agencyConfig.services.map((service) => {
            ...
            return (
              <motion.div
                ...
                className="glass-panel p-8 rounded border border-white/5 shadow-2xl relative overflow-hidden group hover:border-neon-blue/20 transition-all duration-300 flex flex-col justify-between"
              >
                ...
                <div>
                  {/* Service Icon Box */}
                  <div className="h-11 w-11 rounded border border-white/10 bg-white/5 flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300 relative z-10">
                    <IconComponent className={`h-6 w-6 ${service.color}`} />
                  </div>

                  <h3 className="text-white font-display font-bold text-lg mb-3 relative z-10 group-hover:text-neon-blue transition-colors">
                    {service.title}
                  </h3>
